...
// WithPayload adds the payload to the delete service Id not found response
func (o *DeleteServiceIDNotFound) WithPayload(payload models.Error) *DeleteServiceIDNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete service Id not found response
func (o *DeleteServiceIDNotFound) SetPayload(payload models.Error) {
	o.Payload = payload
}
