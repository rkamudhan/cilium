...
/*
GetEndpoint retrieves list of all endpoints

Returns an array of all local endpoints managed by the daemon.
...
/*
GetEndpointID retrieves an endpoint

Looks up and returns the endpoint described with the endpoint ID.
