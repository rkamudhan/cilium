...
Returns the configuration of the daemon which includes addressing
...
/*
GetHealthz retrieves health of cilium daemon

Returns the health and status of the Cilium daemon and all related
components.
